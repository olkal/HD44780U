...
/* Write operation delay, see data sheet and function HD44780U::busy(). I have fond that 37us works well, but it depends on the speed of the LCD internal oscilator, 
